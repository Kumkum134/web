                ...
                <div className="grid lg:grid-cols-4 sm:grid-cols-2 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm md:text-base ">
                           ...
                           <Link to={'https://www.google.com/maps/place/Aurinko+Healthcare+Private+Limited/@28.353984,77.341102,16z/data=!4m6!3m5!1s0x390cdb9766d62aab:0x499dcf82d3074077!8m2!3d28.3499707!4d77.3450554!16s%2Fg%2F11shjs9rvx?entry=ttu&g_ep=EgoyMDI1MDIxNy4wIKXMDSoASAFQAw%3D%3D'}> <li className="hover:text-orange-500 flex">
                                <i className="fa fa-map-marker mr-2"></i> <h3>Plot: 1, Mirzapur, Sec-74, Mirzapur Mor, Ballabhgarh, Faridabad, Haryana-121004 Haryana (India)</h3>
                            </li>
                            </Link>
                        </ul>
                    </div>

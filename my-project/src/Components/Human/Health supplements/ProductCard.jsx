...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full max-w-full h-auto bg-white border overflow-hidden">
      <div className="md:w-1/3 w-full p-2 flex justify-center border">
        <img
